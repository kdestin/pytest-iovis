...
def test_single_mark_on_test_function(
    ...
    res.stdout.fnmatch_lines(
        [
            ...
            f"  <JupyterNotebookTestFunction test_function[[]{notebook_paths[0]}]>",
            "<JupyterNotebookFile test1.ipynb>",
            f"  <JupyterNotebookTestFunction test_function2[[]{notebook_paths[1]}]>",
            "",
        ],
        consecutive=True,
    )
...
def test_multiple_marks_on_test_function(
    ...
    res.stdout.fnmatch_lines(
        [
            ...
            f"  <JupyterNotebookTestFunction test_function[[]{notebook_paths[0]}]>",
            "<JupyterNotebookFile test1.ipynb>",
            f"  <JupyterNotebookTestFunction test_function[[]{notebook_paths[1]}]>",
            "<JupyterNotebookFile test2.ipynb>",
            f"  <JupyterNotebookTestFunction test_function[[]{notebook_paths[2]}]>",
            "",
        ],
        consecutive=True,
    )
...
def test_class_object_fan_out(
    ...
    res.stdout.fnmatch_lines(
        [
            ...
            "  <Class TestClass>",
            f"    <JupyterNotebookTestFunction test_function[[]{notebook_paths[0]}]>",
            f"    <JupyterNotebookTestFunction test_function2[[]{notebook_paths[0]}]>",
            "<JupyterNotebookFile test1.ipynb>",
            "  <Class TestClass>",
            f"    <JupyterNotebookTestFunction test_function[[]{notebook_paths[1]}]>",
            f"    <JupyterNotebookTestFunction test_function2[[]{notebook_paths[1]}]>",
